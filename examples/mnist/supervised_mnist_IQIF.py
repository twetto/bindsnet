...
from bindsnet.models import DiehlAndCook2015IQIFv2
...
parser.add_argument("--n_train", type=int, default=1200)
...
parser.add_argument("--intensity", type=float, default=512)
...
network = DiehlAndCook2015IQIFv2(
    n_inpt=784,
    n_neurons=n_neurons,
    #exc=exc,
    inh=inh,
...
for (i, datum) in enumerate(dataloader):
    ...
    clamp = {"Y": per_class * label.long() + torch.Tensor(choice).long()}
    if gpu:
