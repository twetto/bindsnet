...
from ..network.nodes import Input, LIFNodes, DiehlAndCookNodes, AdaptiveLIFNodes, IQIFNodes, IzhikevichNodes
...
class DiehlAndCook2015IQIF(Network):
    # language=rst
    """
    Implements the spiking neural network architecture from `(Diehl & Cook 2015)
    <https://www.frontiersin.org/articles/10.3389/fncom.2015.00099/full>`_.
...
class DiehlAndCook2015Izhikevich(Network):
    # language=rst
    """
    Implements the spiking neural network architecture from `(Diehl & Cook 2015)
    <https://www.frontiersin.org/articles/10.3389/fncom.2015.00099/full>`_.
    ...
    def __init__(
        ...
        '''
        exc_layer = IzhikevichNodes(n=self.n_neurons, traces=True)
        inh_layer = IzhikevichNodes(n=self.n_neurons, traces=False)
...
class DiehlAndCook2015IQIFv2(Network):
    # language=rst
    """
    Slightly modifies the spiking neural network architecture from `(Diehl & Cook 2015)
    <https://www.frontiersin.org/articles/10.3389/fncom.2015.00099/full>`_ by removing
